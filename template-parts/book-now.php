...
<section class="bg-img-sec-2st">
		<div class="container pt-5">
			<div class="row text-center py-5 position-relative">
				...
				<div class="col-12 col-md-10 col-lg-7 mx-auto">
					<div class="row">
						<div class="col text-center">
							<div class="card-booking is-session p-3">
								...
								<a href="<?php echo SITEURL?>/book" class="d-inline-block btn btn-primary px-4 py-2 semibold w-100">
						...
						<div class="col">
							<div class="card-booking is-distance-session p-3">
								...
								<a href="<?php echo SITEURL?>/book"  class="d-inline-block btn btn-outline-primary px-4 py-2 semibold w-100">
									<span class="lead semibold">Book now</span>
				...
				<img class="figure-img-deco py-5" src="<?php echo THEMEPATH; ?>assets/img/dot_grid_yellow.png" alt="grid dot">
