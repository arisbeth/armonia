					...
					<div class="row">
						<div class="col-12 col-md text-center">
							<div class="card-booking is-session">
								...
								<?php }else{ ?>
									<a href="<?php echo SITEURL?>appointment" class="d-inline-block btn btn-primary px-4 py-2 semibold">
								<?php } ?>
						...
						<div class="col-12 col-md">
							<div class="card-booking is-distance-session">
								...
								<a href="<?php echo SITEURL?>/book"  class="d-inline-block btn btn-outline-primary px-4 py-2 semibold">
									<span class="lead semibold">Book now</span>
